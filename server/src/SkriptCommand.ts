...
export class SkriptCommand extends SkriptSection{
	...
	constructor(context: SkriptContext, parent: SkriptSection){
		...
		if (result == null){
			context.addDiagnostic(context.currentPosition, context.currentString.length, "cannot recognize this command");
		}
	}
	createSection(context: SkriptContext): SkriptSection {
		...
		if (result == null){
			context.addDiagnostic(context.currentPosition, context.currentString.length, "cannot recognize this section. make sure to put your code for the command in triggers");
		}
